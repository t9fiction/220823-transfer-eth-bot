...
const main = async () => {
    ...
    await web3.eth.net.getId()
        .then((chainId)=>{
            if(chainId !== 4){
                console.log("Please select Rinkeby Chain")
            }else{
